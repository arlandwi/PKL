		...
		<div class="row">
			<div class="col-md-8 col-md-offset-2">
				<div class="panel panel-default">
					<div class="panel-heading">{{ $post->title }} | <strong><small>Status : {{ $post->category->name }}</small></strong>
						<div class="pull-right">
	                			{{ csrf_field() }}
	                			<!-- {{ method_field('UPDATE') }} -->
	                			<button type="submit" class="btn btn-xs btn-info" data-id="{{$post->id}} data-toggle="modal" data-target="#addTaskModal" >&nbsp;Add Task&nbsp;</button>	
	                	</div>
